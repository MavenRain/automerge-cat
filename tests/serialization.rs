...
/// Serialize then deserialize, asserting equality.
fn round_trip<T>(val: &T) -> Result<T, Box<bincode::ErrorKind>>
where
...
#[test]
fn gcounter_round_trips() -> Result<(), Box<bincode::ErrorKind>> {
...
#[test]
fn pncounter_round_trips() -> Result<(), Box<bincode::ErrorKind>> {
...
#[test]
fn lww_register_round_trips() -> Result<(), Box<bincode::ErrorKind>> {
...
#[test]
fn mvregister_round_trips() -> Result<(), Box<bincode::ErrorKind>> {
...
#[test]
fn orset_round_trips() -> Result<(), Box<bincode::ErrorKind>> {
    let set = OrSet::empty()
        .add(1_u64, r(0), t(1))
        .add(2, r(1), t(2))
        .remove(&1);
...
#[test]
fn rga_round_trips() -> Result<(), Box<bincode::ErrorKind>> {
...
#[test]
fn text_round_trips() -> Result<(), Box<bincode::ErrorKind>> {
...
#[test]
fn document_round_trips() -> Result<(), Box<dyn std::error::Error>> {
...
#[test]
fn oplog_round_trips() -> Result<(), Box<dyn std::error::Error>> {
    let log = OpLog::empty()
        .append(
            Action::SetKey {
                node: NodeId::Root,
...
#[test]
fn merged_oplog_round_trips() -> Result<(), Box<dyn std::error::Error>> {
